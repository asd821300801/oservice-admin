...
public class SysUserController extends AbstractController {
    ...
    @GetMapping("/info")
    public Result info() {
        Map<String, Object> userDto = Maps.newHashMap();
        SysUserEntity sysUserEntity = getUser();
        if (sysUserEntity != null) {
            userDto.put("userId", sysUserEntity.getUserId());
            userDto.put("username", sysUserEntity.getUsername());
        }
        return Result.ok().put("user", userDto);
    }
    ...
    public static void main(String[] args) {
        //修改密码的方法
        String newPassword = new Sha256Hash("123456", "YzcmCZNvbXocrsz9dm8e").toHex();
